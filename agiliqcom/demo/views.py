...
class GChartDemo(Demo):
    template_name = "graphos/demo/gchart.html"
...
class MorrisDemo(TemplateView):
    template_name = 'graphos/demo/morris.html'
    renderer = None
...
class FlotDemo(Demo):
    template_name = 'graphos/demo/flot.html'
...
class HighChartsDemo(Demo):
    template_name = "graphos/demo/highcharts.html"
...
def time_series_demo(request):
    ...
    return render(request, 'graphos/demo/mongodb_source.html', context)
