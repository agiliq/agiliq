...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('agiliqpages_project', 'category',
                      self.gf('django.db.models.fields.CharField')(default='Web App', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.category'
        db.delete_column('agiliqpages_project', 'category')
    ...
    models = {
        ...
        'agiliqpages.project': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "'Web App'", 'max_length': '100'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
