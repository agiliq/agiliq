...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamMember.user'
        db.add_column('agiliqpages_teammember', 'user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'TeamMember.tag_line'
        db.add_column('agiliqpages_teammember', 'tag_line', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeamMember.user'
        db.delete_column('agiliqpages_teammember', 'user_id')

        # Deleting field 'TeamMember.tag_line'
        db.delete_column('agiliqpages_teammember', 'tag_line')
